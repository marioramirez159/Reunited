...
contract NFTMarket is ReentrancyGuard {
    ...
    //El fee que se le va a pagar al market
...
/* Places an item for sale on the marketplace */
  ...
  function createMarketSale(
    ...
    uint256 itemId
        ...
        //Usando el maping Sacamos el precio y el ID del NFT
  ...
  //       uint price = idToMarketItem[itemId].price;
  //       uint256 tokenId = idToMarketItem[itemId].tokenId;
  //       require(msg.value == price, "Please submit the asking price in order to complete the NFT on sale");
  ...
  function fetchMarketItems() public view returns (MarketItem[] memory) {
    ...
    uint currentIndex = 0;
    //Si el nft no se ha vendido va a devolver los que Nfts que están listados
