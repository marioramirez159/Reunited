...
<div class="row">
    <div class="col-12">
        <div id="titlepath" class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18" style="color: white;">{{ __('Inicio') }}</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active" style="color: white;">¡Bienvenido a {{ config('app.name') }} Inicio</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-xl-4">
                ...
                <div class="row">
                    <div class="col-7">
                        <div class="text-primary p-3">
                            <h5 class="text-primary">{{ __('¡Bienvenido de nuevo!') }}</h5>
                            <p>{{ config('app.name') }} {{ __("Inicio") }}</p>
                        </div>
                    </div>
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">{{ __('Receptionista') }}</p>
                    </div>
                    <div class="col-sm-8">
                        <div class="pt-4">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="font-size-12">{{ __('Ultimo inicio de sesión:') }}</h5>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <a href="{{-- url('profile-edit') --}}"
                                        class="btn btn-primary waves-effect waves-light btn-sm">{{ __('Editar perfil') }}
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">{{ __('Ganancias al mes') }}</h4>
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p class="text-muted font-weight-medium">{{ __("Numero de elementos por pagina") }}</p>
                            <button
    ...
    <div class="col-xl-12">
            ...
            <div class="col-md-6">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium">{{ __('Agregar Pacientes') }}</p>
                                <a href="{{ url('/patient') }}" class="mb-0 font-weight-medium font-size-24">
                                    <h1 class="mb-0">{{ number_format($data['total_patient']) }}</h1>
                                </a>
                            </div>
                            <div class="avatar-sm rounded-circle {{--bg-primary--}} align-self-center mini-stat-icon">
                                <span class="avatar-title rounded-circle bg-primary">
            ...
            <div class="col-md-6">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium">{{ __('Buscar por rostro') }}</p>
                                <a href="{{ url('/urgency/patient/search') }}{{-- url('/upcoming-appointment') --}}"
                                    class="mb-0 font-weight-medium font-size-24">
                                    <h1 class="mb-0">{{ number_format($data['Upcoming_appointment']) }}
                                    </h1>
                                </a>
                            </div>
                            <div class="avatar-sm rounded-circle {{--bg-primary--}} align-self-center mini-stat-icon">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">{{ __("Citas para hoy") }}</h4>
                    ...
                    <table class="table table-centered table-nowrap mb-0">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>{{ __('Nombre doctor') }}</th>
                                <th>{{ __('Fecha') }}</th>
                                <th>{{ __('Contacto No	') }}</th>
                                <th>{{ __('tiempo') }}</th>
                            </tr>
                        </thead>
                        <tbody>
