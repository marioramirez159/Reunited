    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ url('/') }}" class="logo logo-dark"  style="color: white;">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/tabasco.png') }}" alt="" height="60px">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/images/tabasco.png') }}" alt="" height="60px">
                    </span>
                </a>
                <a href="{{ url('/') }}" class="logo logo-light" style="color: white;">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/tabasco.png') }}" alt="" height="60px">
                    </span>
                    <span class="logo-lg">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{-- url('profile-edit') --}}"><i
                        class="bx bx-user font-size-16 align-middle mr-1"></i> {{ __("Editar perfil") }}</a>
                    <a class="dropdown-item" href="{{ url('payment-key') }}"><i
                        class="bx bx-key font-size-16 align-middle mr-1"></i> {{ __("Agregar Api Key") }}</a>
                    @endif
                    <a class="dropdown-item d-block" href="{{ url('change-password') }}"><i
                            class="bx bx-wrench font-size-16 align-middle mr-1"></i> {{ __("Cambiar Password") }}</a>
