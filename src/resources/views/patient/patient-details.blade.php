                ...
                <div id="titlepath" class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">
                        @if ($patient && $patient_info && $medical_info)
                            {{ __('Actualizar los datos de un paciente') }}
                        @else
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">
                                @if ($patient)
                                    {{ __('Actualizar datos de un paciente') }}
                                @else
                                    {{ __('Agregar nuevo paciente') }}
                                @endif
                            </li>
                    ...
                    @if ($role == 'patient')
                        <a href="{{ url('/') }}">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle mr-2"></i>{{ __('Regresar a la lista de pacientes') }}
                            </button>
                        </a>
                    @else
                        <a href="{{ url('patient/' . $patient->id) }}">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle mr-2"></i>{{ __('Regrasar al perfil') }}
                            </button>
                        </a>
                    @endif
                @else
                        ...
                        <form action="@if ($patient ) {{ url('patient/' . $patient->id) }} @else {{ route('patient.store') }} @endif" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label">{{ __('Nombre del paciente') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('name') is-invalid @enderror"
                                                name="name" id="name" tabindex="1"
                                                value="@if($patient) {{ $patient->first_name.' '.$patient->last_name }}@elseif(old('name')){{ old('name') }}@endif"
                                                placeholder="{{ __('Escribe el nombre del paciente') }}"  onkeyup="loadnames(this)" onchange="loadnames(this)">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label">{{ __('CURP') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('curp') is-invalid @enderror"
                                                name="curp" id="curp" tabindex="1"
                                                value="@if ($patient){{ old('curp', $patient->curp) }}@elseif(old('curp')){{ old('curp') }}@endif"
                                                placeholder="{{ __('Escribe el CURP') }}">
                                            @error('curp')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('Escribe el No. de Teléfono') }}">
                                            @error('mobile')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label">{{ __('No. de Afiliación') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('noaf') is-invalid @enderror"
                                                name="noaf" id="noaf" tabindex="1"
                                                value="@if ($patient){{ old('noaf', $patient->noaf) }}@elseif(old('noaf')){{ old('noaf') }}@endif"
                                                placeholder="{{ __('Escribe el nombre No. de Afiliación') }}">
                                            @error('noaf')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label">{{ __('Domicilio') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('address') is-invalid @enderror"
                                                name="address" id="address" tabindex="1"
                                                value="@if ($patient){{ old('address', $patient->address) }}@elseif(old('address')){{ old('address') }}@endif"
                                                placeholder="{{ __('Escribe el Domicilio') }}">
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label">{{ __('Correo electrónico') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('email') is-invalid @enderror"
                                                name="email" id="email" tabindex="1"
                                                value="@if ($patient){{ old('email', $patient->email) }}@elseif(old('first_name')){{ old('email') }}@endif"
                                                placeholder="{{ __('Escribe el correo electrónico') }}">
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary">
                                        @if ($patient && $patient_info && $medical_info)
                                            {{ __('Actualizar detalles del paciente') }}
                                        @else
                                            {{ __('Agregar nuevo paciente') }}
                                        @endif
                                    </button>
