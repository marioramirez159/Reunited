                    ...
                    <div class="card-body">
                        <a href=" {{ route('patient.create') }} ">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i class="bx bx-plus font-size-16 align-middle mr-2"></i> {{ __('Nuevo paciente') }}
                            </button>
                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href=" javascript:void(0)">
                                                <button type="button"
                                                    class="btn btn-primary btn-sm btn-rounded waves-effect waves-light mb-2 mb-md-0"
                                                    title="Desactivar Perfil" data-id="{{ $patient->id }}"
                                                    id="delete-patient">
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Viendo de {{ $patients->firstItem() }} a {{ $patients->lastItem() }} un total de: {{ $patients->total() }} entradas
                            </div>
