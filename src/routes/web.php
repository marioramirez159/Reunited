...
Route::post('patient/searchbyface', 'PatientController@searchbyface');
Route::resource('patient', 'PatientController');

Route::get('urgency/{id}/create', 'UrgencyController@createbyid');
Route::resource('urgency', 'UrgencyController');

Route::get('urgency/patient/search', 'UrgencyController@searchpatient');
