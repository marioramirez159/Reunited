                    ...
                    <div class="card-body">
                        <a href=" <?php echo e(route('patient.create')); ?> ">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i class="bx bx-plus font-size-16 align-middle mr-2"></i> <?php echo e(__('Nuevo paciente')); ?>
                        ...
                        <table class="table table-bordered dt-responsive nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('No Contacto')); ?></th>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a href=""><?php echo e($patient->first_name); ?>
                                        ...
                                        <td>
                                            ...
                                            <a href=" javascript:void(0)">
                                                <button type="button"
                                                    class="btn btn-primary btn-sm btn-rounded waves-effect waves-light mb-2 mb-md-0"
                                                    title="Desactivar Perfil" data-id="<?php echo e($patient->id); ?>"
                                                    id="delete-patient">
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Viendo de <?php echo e($patients->firstItem()); ?> a <?php echo e($patients->lastItem()); ?> un total de: <?php echo e($patients->total()); ?> entradas
                            </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/patient/patients.blade.php ENDPATH**/ ?>