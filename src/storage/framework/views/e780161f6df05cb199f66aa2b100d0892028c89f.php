...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Escribe el No. de Teléfono')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('No. de Afiliación')); ?><span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Escribe el nombre No. de Afiliación')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Correo electrónico')); ?><span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Escribe el correo electrónico')); ?>">
