    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(url('/')); ?>" class="logo logo-dark"  style="color: white;">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('assets/images/tabasco.png')); ?>" alt="" height="60px">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('assets/images/tabasco.png')); ?>" alt="" height="60px">
                    </span>
                </a>
                <a href="<?php echo e(url('/')); ?>" class="logo logo-light" style="color: white;">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('assets/images/tabasco.png')); ?>" alt="" height="60px">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href=""><i
                        class="bx bx-user font-size-16 align-middle mr-1"></i> <?php echo e(__("Editar perfil")); ?></a>
                    <a class="dropdown-item" href="<?php echo e(url('payment-key')); ?>"><i
                        class="bx bx-key font-size-16 align-middle mr-1"></i> <?php echo e(__("Agregar Api Key")); ?></a>
                    <?php endif; ?>
                    <a class="dropdown-item d-block" href="<?php echo e(url('change-password')); ?>"><i
                            class="bx bx-wrench font-size-16 align-middle mr-1"></i> <?php echo e(__("Cambiar Password")); ?></a>
...
<?php /**PATH /var/www/html/resources/views/layouts/top-hor.blade.php ENDPATH**/ ?>